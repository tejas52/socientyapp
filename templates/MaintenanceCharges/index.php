...
<div class="card mb-4">
        ...
        $sms = "Dear " . $charge->member->name . ", Your maintenance charge for " . $monthname . "-" . $charge->year . " of Rs." . $charge->amount+$charge->penalty_paid . " is paid successfully. You can find payment receipt on your email. Thank you."; 
        ?>
        ...
        <td><?= h($charge->member->flat->flat_no) ?></td>
