        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../index.html" class="nav-link">
                       <?= $this->Html->link("Societies ({$societiesCount})", ['controller'=>'Societies','action'=>'index'], ['class'=>'nav-link'] ) ?>
                    </a>
                  </li>
                  <li class="nav-item">
              ...
              <li class="nav-item">
               <a href="<?= $this->Url->build(['controller' => 'Wings', 'action' => 'index']) ?>" class="nav-link">
                    <i class="nav-icon bi bi-box-seam-fill"></i>
                    <p>
                        Wings
                        <i class="nav-arrow bi bi-chevron-right"></i>
              ...
              <li class="nav-item">
                <a href="<?= $this->Url->build(['controller' => 'Flats', 'action' => 'index']) ?>" class="nav-link">
                    <i class="nav-icon bi bi-box-seam-fill"></i>
                    <p>
                        Flats
                        <i class="nav-arrow bi bi-chevron-right"></i>
              ...
              <li class="nav-item">
                <a href="<?= $this->Url->build(['controller' => 'MaintenanceCharges', 'action' => 'index']) ?>" class="nav-link">
                    <i class="nav-icon bi bi-box-seam-fill"></i>
                    <p>
                        Maintenance Charges
                        <i class="nav-arrow bi bi-chevron-right"></i>
