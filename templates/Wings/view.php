...
<p><strong>ID:</strong> <?= h($wing->society->name) ?></p>
<p><strong>Wing:</strong> <?= h($wing->name) ?></p>


<p>
<?= $this->Html->link(' Edit ', '/wings/edit/' . $wing->id, ['class' => 'btn btn-info']) ?>    <?= $this->Form->postLink('🗑 Delete', 
